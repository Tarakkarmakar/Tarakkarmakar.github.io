...
window.open("https://shopiteasy-amar1998deep-gmailcom.vercel.app")
    }
...
Myntra is the india's largest e-commerce store for fashion and
   lifestyle products, Myntra aims at providing a hassle-free
    and enjoyable shopping experience to shoppers 
  ...
  <div  className="btn_box">
    ...
    <button className="button pbutton" onClick={()=>openlInk("shopCode")}>Code</button>
    <button className="button pbutton" onClick={()=>openlInk("shopDemo")}>Demo</button>
  </div>
